#!/bin/bash
# Trace-based workload sweep for 3x Qwen2.5-14B-Instruct.
#
# For each R_peak, generates a realistic mixed-workload trace via
# plot_workload_design.py, then replays it across all 3 instances
...
#
# Usage:
#   bash run_trace_sweep_14b.sh [tag] [results_dir] [options]
#
...
#
# Examples:
#   bash run_trace_sweep_14b.sh kvcached-14b results/trace-kvcached
#   bash run_trace_sweep_14b.sh baseline-14b results/trace-baseline --r-peaks "20 25 30"
#   bash run_trace_sweep_14b.sh kvcached-14b results/trace-kvcached --r-peak-start 15 --r-peak-end 35 --r-peak-step 5
...
SEED=42
N_INSTANCES=3        # must match number of entries in MODELS
