...
fake_interfaces = types.ModuleType("kvcached.integration.vllm.interfaces")
fake_interfaces.should_use_worker_ipc = lambda: False
sys.modules.setdefault("kvcached.integration", types.ModuleType("kvcached.integration"))
sys.modules.setdefault("kvcached.integration.vllm", types.ModuleType("kvcached.integration.vllm"))
sys.modules.setdefault("kvcached.integration.vllm.interfaces", fake_interfaces)
